...
public class VenueController {
    ...
    @PostMapping
    public ResponseEntity<SuccessResponse<Void>> register(@Valid @RequestBody RegisterVenueRequest request) {
    ...
    public ResponseEntity<SuccessResponse<Void>> delete(@PathVariable Long venueId) {
    ...
    @PreAuthorize("hasAuthority('ADMIN')")
    @PutMapping("/{venueId}")
    public ResponseEntity<SuccessResponse<Void>> changeAddress(@PathVariable Long venueId,
    ...
    @GetMapping
    public ResponseEntity<SuccessResponse<List<VenueData>>> getActivateVenueList() {
        return ResponseEntity.status(HttpStatus.OK)
                .body(SuccessResponse.success(venueQueryService.getActivateVenueList()));
    }
}
