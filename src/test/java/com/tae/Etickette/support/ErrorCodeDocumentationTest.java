...
/**
 * build/generated-snippets/code-response-fields-beneath-errorCodes.adoc
 * 위의 위치에 문서화된 .adoc 파일을 작성하는 테스트 코드
 */
...
public class ErrorCodeDocumentationTest {
    ...
    public void errorCodeDocumentation() throws Exception {
        // given + when
        ResultActions result = mockMvc.perform(get("/errors").accept(MediaType.APPLICATION_JSON));
