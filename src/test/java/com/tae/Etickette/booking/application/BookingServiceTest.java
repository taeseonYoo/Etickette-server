...
class BookingServiceTest {
    ...
    @BeforeEach
    void setUp() {
        bookingService = new BookingService(memberFinder, sessionFinder, bookingRepository, bookSeatRepository);
    }
    ...
    void 예약_실패_세션이없음() {
        //given
        BookingRequest request = BookingRequest.builder().sessionId(1L).seatIds(List.of(1L, 2L)).build();
